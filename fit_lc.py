...
if functions.read_config_file("RUN_MCMC") == "true":
    ...
    x0 = fitting_functions.mcmc_loop(free_param_vals,free_param_names,fixed_param_names,fixed_param_vals,free_param_names,free_param_range,lc,False,cadence)

    print free_param_names
    print x0*free_param_vals+free_param_vals


fitting_functions.calc_master_chisq(free_param_vals,free_param_names,fixed_param_names,fixed_param_vals,free_param_names,free_param_range,lc,True,cadence)
